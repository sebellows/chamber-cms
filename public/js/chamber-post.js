  ...
  if (typeof acf != "undefined") {
    ...
    if ( typeof acf.add_action !== 'undefined' ) {
      ...
      acf.add_action('ready append', function( $el ) {
        ...
        // search $el for fields of type 'svgiconpicker'
        initialize_field($el);
...
/**
 * jQuery SvgIconPicker
 *
 * An icon picker built on top of font icons and jQuery
 *
 * Modified from the fontIconPicker jQuery plugin
 * Created by Alessandro Benoit & Swashata
 * @link http://codeb.it/fonticonpicker/
 * @src  https://github.com/micc83/fontIconPicker
 */
...
;(function ($) {
  ...
  Plugin.prototype = {
    ...
    renderIconContainer: function () {
      ...
      if (this.settings.emptyIcon) {
        ...
        this.iconContainer.html('<span class="chamber-box"><svg class="chamber-icon-block" data-chamber-value="chamber-icon-block" viewBox="0 0 32 32" fill="#ec5840"><use xlink:href="#icon-ban" /></svg></span>');

      // If not show an error when no icons are found
      } else if (iconsPaged.length < 1) {
        this.iconContainer.html('<span class="icons-picker-error"><svg class="chamber-icon-block" data-chamber-value="chamber-icon-block" viewBox="0 0 32 32" fill="#ec5840"><use xlink:href="#icon-ban" /></svg></span>');
        return;
    ...
    setSelectedIcon: function (theIcon) {
      ...
      // Use class
        ...
        this.iconPicker.find('.selected-icon').html('<svg class="' + (theIcon || 'chamber-icon-block') + '" viewbox="0 0 32 32"><use xlink:href="#' + (theIcon || 'icon-ban') + '" /></svg>');
      }
  ...
  $.fn.svgIconPicker = function (options) {

    // Instantiate the plugin
    this.each(function () {
      if (!$.data(this, "svgIconPicker")) {
        $.data(this, "svgIconPicker", new Plugin(this, options));
      }
    });
    ...
    this.setIcons = $.proxy(function (newIcons, iconSearch) {
      ...
      this.each(function () {
        $.data(this, "svgIconPicker").settings.source = newIcons;
        $.data(this, "svgIconPicker").settings.searchSource = iconSearch;
        $.data(this, "svgIconPicker").initSourceIndex();
        $.data(this, "svgIconPicker").resetSearch();
        $.data(this, "svgIconPicker").loadIcons();
      });
    }, this);
    ...
    this.destroyPicker = $.proxy(function() {
      this.each(function() {
        ...
        $.data(this, "svgIconPicker").iconPicker.remove();
        // Reset the CSS
        $.data(this, "svgIconPicker").element.css({
          visibility: '',
          top: '',
          position: '',
          zIndex: '',
    ...
    this.refreshPicker = $.proxy(function(newOptions) {
      ...
      this.each(function() {
        if (!$.data(this, "svgIconPicker")) {
          $.data(this, "svgIconPicker", new Plugin(this, newOptions));
        }
      });
    }, this);
...
(function () {
  ...
  var createTooltip = function(x) {
    ...
    var tooltipContent = getTitleValue(x);
    var tooltipArrow = createArrow();
  ...
  var removeTooltip = function() {
    var tooltipParent = document.querySelector('.chamber-tooltip').parentNode;
